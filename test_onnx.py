...
# adaface = load_model_onnx('./onnx/adaface_50w.onnx')

# emb = process_onnx_adaFace(rotate_img, adaface)
# import onnxruntime
...
if __name__ == '__main__':
    ...
    while cam.grabbed(): # Return True nếu cam đọc được frame
        ...
        # frame = np.reshape(frame, [1, 3, 384, 384]).astype(np.float32)
        # print("Frame : ",f , '\n')
        ...
        for i, track in enumerate(tracker.tracks):
            print("Passssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss")
