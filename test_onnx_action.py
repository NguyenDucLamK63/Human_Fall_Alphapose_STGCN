...
from DetectorLoader import TinyYOLOv3_onecls , detect_onnx

from PoseEstimateLoader import SPPE_FastPose , pose_predict
...
if __name__ == '__main__':
    ...
    session_pose = onnxruntime.InferenceSession("/home/duclam/Lam/fall_detection/Human-Falling-Detect-Tracks_2/Models/onnx/alphapose_res50_multi_requires_dynamic.onnx",providers=['CUDAExecutionProvider']) 
    # POSE MODEL.
    ...
    while cam.grabbed(): #Return True nếu cam đọc được frame
        ...
        detected = detect_onnx(session_detect,frame, conf_thres = 0.45, nms = 0.2 ,input_size = 384,expand_bb = 10, need_resize = False)
        ...
        if detected is not None:
            ...
            poses = pose_predict(session_pose, frame, detected[:, 0:4], detected[:, 4] , inp_h = inp_pose[0],inp_w = inp_pose[1]) # 13x2 (float32)
            # print("poses : ", poses)
